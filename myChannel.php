...
<body>
    <div id="navbar">
        <a href="#" class="menu-bars" id="show-menu" title="Menu">
            ...
            <a href="menu.php">
                <h1><i class="fab fa-youtube" id="youtube-logo"></i>OurTube</h1>
            </a>
        </a>
        <div id="search-bar">
    ...
    <div class="main-content">
        ...
        <div class="main-body-min-navbar" id="main-body">
            ...
            <div class="nav_profile_min" id="nav_profile">
                <nav class="nav_bar">
                    <button class="nav_bar_button" id="home" onclick="ViewHome()">Home</button>
                    <script>
                        function ViewVideos() {
                            document.getElementById("content").style.display = "none";
                            document.getElementById("channel_main_body").innerHTML = "";
                            document.getElementById("channel_main_body").style.display = "block";
                            ...
                            ?>
                                ...
                                a.href = "EditVideo.php?UploadedVideosID=" + "<?= $video["UploadedVideosID"] ?>" + "&UploadedVideoNamef=" + "<?= $video["UploadedVideoNamef"] ?>" + "&UploadedVideosDescription=" + "<?= $video["UploadedVideosDescription"] ?>";
                                a.innerHTML = "<?= $video["UploadedVideoNamef"] ?>"
                                document.getElementById("Editdiv").appendChild(a);
                    ...
                    <button class="nav_bar_button" id="videos" onclick="ViewVideos()">Videos</button>

                    <!-- <button class="nav_bar_button" id="playlists">PlayLists</button> -->
                    <button class="nav_bar_button" id="Stats" onclick="GetStat(<?= $uid ?>)">Stat</button>
                    <button class="nav_bar_button" id="Edit" onclick="EditVideo()">Edit</button>
                </nav>
            </div>
            <div id="channel_main_body"></div>
            <div id="Stat"></div>
            <div id="Editdiv"></div>
