...
<div id="navbar">
    ...
    <div class="main-content">
        ...
        <div class="main-body-min-navbar" id = "upload-card">
            ...
            <form action='processing.php' class="video-form" method='POST' enctype="multipart/form-data" >
                <div class="form-group">
                    <label for='file-input' style='font-size:15pt;'>Video:</label>
                    <input type='file' id='file-input' name='file-input' required>
                </div>
                <div class="form-group">
                    <label for='thumbnail-input' style='font-size:15pt;'>Thumbnail:</label>
                    <input type='file' id='thumbnail-input' name='thumbnail-input' required>
                </div>
                <div class="form-group">
                    <input type='text' class="form-control" name="title-input" placeholder='Title' required>
                </div>
                <div class="form-group">
                ...
                <button name="upload-button" id="upload-button">Upload</button>
            </form>
        </div>
